...
import com.github.tangram.fee.common.util.SpringContextHolder;
...
public class BasicEntityIdGenerator implements EntityIdGenerator {
    ...
    protected long getRandomDatacenterId() {
        //
        long machineId=redisTemplate.opsForValue().increment("machineId", 1)%1024;
//        long lastIp;
//        try {
//            InetAddress address = InetAddress.getLocalHost();
//            String ip=address.getHostAddress();
//            lastIp=Long.parseLong(ip.substring(ip.lastIndexOf(".")+1,ip.length()));
//        } catch (UnknownHostException e) {
//            e.printStackTrace();
//            lastIp=r.nextInt((int) maxDatacenterId);
//        }
        return machineId;
    }
